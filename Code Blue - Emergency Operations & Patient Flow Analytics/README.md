...
This project is an interactive \*\*Power BI Healthcare Analytics Dashboard\*\* developed for the \*\*FP20 Analytics Challenge 38\*\*.



The dashboard provides insights into hospital performance, workforce efficiency, and financial sustainability, enabling stakeholders to identify operational bottlenecks and support data-driven decision-making.
...
The objective of this project is to monitor emergency department operations by answering key business questions:
...
- Does equipment investment improve profitability?
...
This project demonstrates how healthcare analytics can be used to connect operational, workforce, and financial data to identify improvement opportunities.



The analysis highlights the relationship between staff burnout, patient wait times, readmission rates, and patient satisfaction, helping healthcare stakeholders make informed decisions to improve operational efficiency and patient care.
